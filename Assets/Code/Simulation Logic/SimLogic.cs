...
namespace DCATS.Assets.Attachable
{
    public partial class SimLogic : MonoBehaviour {
        ...
        // update installed components (called by Event Listeners)
        public static void UpdateComponents<TSlotType> (AttachableBase<TSlotType> attachBase, TSlotType slot) where TSlotType : AttachGrabberBase
        {
        ...
        //public static void UpdateComponents2(BaseGrabbable obj)
        //{            
        //    switch(obj.name)
        //    {
